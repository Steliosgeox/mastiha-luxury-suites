...
const en = {
  ...
  familyEyebrow: 'For little travellers', familyTitle: 'Small guests.\nThought through.', familyBody: 'Booking.com currently lists a free cot for ages 0–3 and welcomes children of all ages. Ask Athina before arrival so the family setup can be ready when you get there.', familyItems: ['Free cot · ages 0–3','Children of all ages welcome','Family-friendly stay'], familyMediaLabels: ['Playpen','Play corner','Cot · on request'],
...
const el: Copy = {
  ...
  familyEyebrow:'Για τους μικρούς επισκέπτες', familyTitle:'Μικροί επισκέπτες.\nΜεγάλη φροντίδα.', familyBody:'Το Booking.com αναφέρει δωρεάν βρεφική κούνια για ηλικίες 0–3 ετών και δέχεται παιδιά όλων των ηλικιών. Ενημερώστε την Αθηνά πριν την άφιξη ώστε η οικογενειακή διαμόρφωση να είναι έτοιμη.', familyItems:['Δωρεάν κούνια · 0–3 ετών','Παιδιά όλων των ηλικιών','Οικογενειακή διαμονή'], familyMediaLabels:['Παρκοκρέβατο','Γωνιά παιχνιδιού','Κούνια · κατόπιν αιτήματος'],
...
const tr: Copy = {
  ...
  familyEyebrow:'Küçük misafirler için', familyTitle:'Küçük misafirler.\nÖzenle düşünülmüş.', familyBody:'Booking.com şu anda 0–3 yaş için ücretsiz bebek yatağı listeliyor ve her yaştan çocuğu kabul ediyor. Aile düzeninin hazır olması için varıştan önce Athina’ya haber verin.', familyItems:['Ücretsiz bebek yatağı · 0–3 yaş','Her yaştan çocuk kabul edilir','Aile dostu konaklama'], familyMediaLabels:['Park yatak','Oyun köşesi','Bebek yatağı · talep üzerine'],
