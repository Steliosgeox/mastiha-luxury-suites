...
export const propertyData: PropertyData = {
  ...
  amenities: [
    ...
    { id: "sea-view", title: "Aegean Sea Views", category: "outdoor", highlight: true, description: "Panoramic Mediterranean horizon" },
    ...
    { id: "wifi", title: "High-Speed Wi-Fi", category: "tech", highlight: true, description: "Measured around 92 Mbps" },
    ...
    { id: "terrace", title: "Private Terrace & Patio", category: "outdoor", highlight: true, description: "Woven outdoor lounge seating overlooking pines" },
